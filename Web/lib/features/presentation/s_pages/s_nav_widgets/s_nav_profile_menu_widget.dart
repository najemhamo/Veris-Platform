...
class SNavProfileNavWidget extends StatefulWidget {
  final String uid;
  const SNavProfileNavWidget({Key? key,required this.uid}) : super(key: key);

  @override
  _SNavProfileNavWidgetState createState() => _SNavProfileNavWidgetState();
}

class _SNavProfileNavWidgetState extends State<SNavProfileNavWidget> {
  @override
